...
export default fp(async function (fastify: FastifyInstance) {
    ...
    consumer.on('message', async (channel, message) => {
        try {
            ...
            const url = `${process.env.STEAM_API_URL}/IPlayerService/GetOwnedGames/v0001/?steamid=${payload.steamid}&include_appinfo=true&include_played_free_games=true&format=json`
